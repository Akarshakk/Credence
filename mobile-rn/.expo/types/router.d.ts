...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/expenses` | `/expenses` | `/(tabs)/income` | `/income` | `/(tabs)/` | `/(tabs)` | `/(tabs)/profile` | `/profile` | `/(tabs)/splitwise` | `/splitwise` | `/add-expense` | `/add-income` | `/analytics` | `/auth/login` | `/auth/register` | `/create-group` | `/debts` | `/scan-bill`;
  // prettier-ignore
