...
This directory contains reusable Flutter widgets used across the F-Buddy app.
...
**Usage:**
```dart
import 'package:f_buddy/widgets/rag_chat_widget.dart';

// Add to any screen with Stack
Stack(
  children: [
    // Your main content
    YourContent(),
